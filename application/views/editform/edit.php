    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="form-group">
                <label>Name</label>
                <input type="text" data-id="<?php echo $users['id'];?>" name = "name"  id="updateUser"  value = "<?php echo set_value('nombre').$users['nombre'];?>" class = "form-control">
            ...
            !-->
            <div class="form-group">
                <button type="button" data-id="<?php echo $users['id'];?>" id="updatebutton"  class = "btn btn-primary">Update</button>
        ...
        <script src="<?php echo base_url('/js/updatemessage.js');?>"></script>
    </div>
    </form>
</div>
